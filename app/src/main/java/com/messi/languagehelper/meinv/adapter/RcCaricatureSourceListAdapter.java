...
public class RcCaricatureSourceListAdapter extends HeaderFooterRecyclerViewAdapter<RecyclerView.ViewHolder, Object, AVObject, Object> {

    private XFYSAD mXFYSAD;

    public RcCaricatureSourceListAdapter(XFYSAD mXFYSAD){
    ...
    protected RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = getLayoutInflater(parent);
        View characterView = inflater.inflate(R.layout.website_list_item, parent, false);
        return new RcCaricatureSourceItemViewHolder(characterView);
    }

    @Override
    protected void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        AVObject mAVObject = getItem(position);
        RcCaricatureSourceItemViewHolder itemViewHolder = (RcCaricatureSourceItemViewHolder)holder;
