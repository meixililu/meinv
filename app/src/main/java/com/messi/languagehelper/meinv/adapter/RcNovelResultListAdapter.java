...
public class RcNovelResultListAdapter extends HeaderFooterRecyclerViewAdapter<RecyclerView.ViewHolder, Object, CNWBean, Object> {
    ...
    protected RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RcNovelResultListItemViewHolder(characterView);
    }

    @Override
    protected void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        CNWBean mAVObject = getItem(position);
        RcNovelResultListItemViewHolder itemViewHolder = (RcNovelResultListItemViewHolder)holder;
